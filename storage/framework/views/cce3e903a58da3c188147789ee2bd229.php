            ...
            <div class="card-body ">
                <blockquote class="blockquote mb-0">
                    <table class="table table-striped table-bordered rounded">
                        <thead>
                            <tr class="rounded">
                                <th class="table-bordered rounded">No</th>
                                <th>Kode Barang</th>
                                <th>Nama Barang</th>
                                <th>Harga Barang</th>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="<?php echo e(route('barang.show', ['barang' => $barang->id])); ?>"
                                                class="btn btn btn-primary btn-sm me-2"><i
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fariduta/Pictures/uts/uts-framework/resources/views/barang/index.blade.php ENDPATH**/ ?>