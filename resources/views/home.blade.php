...
<div class="container-fluid blue-bg mx-auto">
  <div class="row justify-content-center flex-lg-row-reverse align-items-center g-5 py-5">
    <div class="col-10 col-sm-8 col-lg-4">
      <img src="{{ Vite::asset('resources/images/logistik.png') }}" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy">
    </div>
    <div class="col-lg-6">
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-start">
          <a class="btn btn-warning"  href="{{ route('barang.index') }}">Cek barang</a>
